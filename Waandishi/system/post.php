                      ...
                      <tbody>
                        <?php 
                          ...
                          if($_SESSION["role"] == 3) {
                            ...
                            $selectSql = "SELECT * FROM post LEFT JOIN user ON post.author = user.user_id WHERE author = {$_SESSION['user_id']} ORDER BY post_id DESC LIMIT {$offset},{$limit}";
                          }
                         ...
                         ?>
                          <tr>
                              ...
                              <td class='delete'><a href='delete-post.php?id=> <i class='fa fa-trash-o'></i></a></td>
                          </tr>
                          <?php 
