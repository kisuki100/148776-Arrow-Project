            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php 
                    ...
                    $selectSql = "SELECT * FROM post LEFT JOIN user ON post.author = user.user_id WHERE post.title LIKE '%{$search_term}%' OR post.description LIKE '%{$search_term}%' ORDER BY post_id DESC LIMIT {$offset},{$limit}";
